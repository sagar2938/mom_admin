(function() {
	...
	I.f.va = function(b, c) {
		if (c) b = b.replace(I.f.fe, "&amp;").replace(I.f.Ee, "&lt;").replace(I.f.Be, "&gt;").replace(I.f.Le, "&quot;").replace(I.f.Ne, "&#39;").replace(I.f.Ge, "&#0;"), I.f.Rc && (b = b.replace(I.f.xe, "&#101;"));
			...
			if (!I.f.th.test(b)) return b; - 1 != b.indexOf("&") && (b = b.replace(I.f.fe, "&amp;")); - 1 != b.indexOf("<") && (b = b.replace(I.f.Ee, "&lt;")); - 1 != b.indexOf(">") && (b = b.replace(I.f.Be, "&gt;")); - 1 != b.indexOf('"') && (b = b.replace(I.f.Le, "&quot;")); - 1 != b.indexOf("'") && (b = b.replace(I.f.Ne, "&#39;")); - 1 != b.indexOf("\x00") && (b = b.replace(I.f.Ge, "&#0;"));
	...
	I.g.userAgent.platform.Lb = function() {
		var b = I.g.userAgent.A.pb(),
			c = "";
		I.g.userAgent.platform.Eg() ? (c = /Windows (?:NT|Phone) ([0-9.]+)/, c = (b = c.exec(b)) ? b[1] : "0.0") : I.g.userAgent.platform.ug() ? (c = /(?:iPhone|iPod|iPad|CPU)\s+OS\s+(\S+)/, c = (b = c.exec(b)) && b[1].replace(/_/g, ".")) : I.g.userAgent.platform.yg() ? (c = /Mac OS X ([0-9_.]+)/, c = (b = c.exec(b)) ? b[1].replace(/_/g, ".") : "10") : I.g.userAgent.platform.ng() ? (c = /Android\s+([^\);]+)(\)|;)/, c = (b = c.exec(b)) && b[1]) : I.g.userAgent.platform.pg() && (c = /(?:CrOS\s+(?:i686|x86_64)\s+([0-9.]+))/, c = (b = c.exec(b)) && b[1]);
		return c || ""
	};
	...
	I.h.i = {};
	I.h.i.Rh = !1;
	I.h.i.De = I.h.i.Rh || ("ar" == I.I.substring(0, 2).toLowerCase() || "fa" == I.I.substring(0, 2).toLowerCase() || "he" == I.I.substring(0, 2).toLowerCase() || "iw" == I.I.substring(0, 2).toLowerCase() || "ps" == I.I.substring(0, 2).toLowerCase() || "sd" == I.I.substring(0, 2).toLowerCase() || "ug" == I.I.substring(0, 2).toLowerCase() || "ur" == I.I.substring(0, 2).toLowerCase() || "yi" == I.I.substring(0, 2).toLowerCase()) && (2 == I.I.length || "-" == I.I.substring(2, 3) || "_" == I.I.substring(2, 3)) || 3 <= I.I.length && "ckb" == I.I.substring(0, 3).toLowerCase() && (3 == I.I.length || "-" == I.I.substring(3, 4) || "_" == I.I.substring(3, 4)) || 7 <= I.I.length && ("-" == I.I.substring(2, 3) || "_" == I.I.substring(2, 3)) && ("adlm" == I.I.substring(3, 7).toLowerCase() || "arab" == I.I.substring(3, 7).toLowerCase() || "hebr" == I.I.substring(3, 7).toLowerCase() || "nkoo" == I.I.substring(3, 7).toLowerCase() || "rohg" == I.I.substring(3, 7).toLowerCase() || "thaa" == I.I.substring(3, 7).toLowerCase()) || 8 <= I.I.length && ("-" == I.I.substring(3, 4) || "_" == I.I.substring(3, 4)) && ("adlm" == I.I.substring(4, 8).toLowerCase() || "arab" == I.I.substring(4, 8).toLowerCase() || "hebr" == I.I.substring(4, 8).toLowerCase() || "nkoo" == I.I.substring(4, 8).toLowerCase() || "rohg" == I.I.substring(4, 8).toLowerCase() || "thaa" == I.I.substring(4, 8).toLowerCase());
	I.h.i.kb = {
		Wh: "\u202a",
		$h: "\u202b",
		Je: "\u202c",
	...
	I.b.v.cl = function(b) {
		...
		} else return I.o.ha("String value allows only " + I.b.v.Te + " and simple functions, got: " + b), I.b.v.ga;
		return I.b.v.dl(b)
	};
	I.b.v.Qj = function(b) {
	...
	I.a.df = function(b, c) {
		...
		if ("sourceIndex" in b || b.parentNode && "sourceIndex" in b.parentNode) {
			...
			var f = b.parentNode,
				g = c.parentNode;
			return f == g ? I.a.ff(b, c) : !d && I.a.contains(f, c) ? -1 * I.a.ef(b, c) : !e && I.a.contains(g, b) ? I.a.ef(c, b) : (d ? b.sourceIndex : f.sourceIndex) - (e ? c.sourceIndex : g.sourceIndex)
		}
		e = I.a.Qa(b);
		d = e.createRange();
		d.selectNode(b);
	...
	*/
	...
	function U(b) {
		...
		b.la = c;
		e ? (e = I.bind(b.hf, b, !0), l = I.bind(b.hf, b, !1), c instanceof I.async.B ? (Y(c, e, l), c.Oi = !0) : c.then(e, l)) : I.async.B.li && c instanceof Error && !(c instanceof I.async.B.hb) && (d = b.rb = !0);
